...
/**
 * Choose the resolution of the swap images in the frame buffer.  Prefer
 * the current extent (same resolution as the window), but if the window
 * manager does not allow us, then select the maximum allowed
 * height/width.
 */
